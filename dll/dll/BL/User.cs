...
namespace dll.BL
{
    public class User
    {
        ...
        public bool UpdateUser(int UserID, string Password, string Username, string Email, int roleID, string Phone, string Name)
        {
            bool flag = DL.User.UpdateUsertoDB(UserID, Username ,Password, roleID, Email,  Phone,  Name);
            return flag;
        }
